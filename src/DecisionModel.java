...
public class DecisionModel implements ModelInterface{
    ...
    public int insert(String fieldNames, List<Object> rows) throws Exception {
        // construct SQL statement
        StringBuilder sql = new StringBuilder();
        sql.append(" INSERT INTO Decision (" + fieldNames + ") ");
        sql.append(" VALUES ");
        ...
        for (int i = 0; i < rows.size(); i++) {
            if (rows.get(i) instanceof Decision) {
                rowCount++;

                Decision decision = (Decision) rows.get(i);
    ...
    public int update(Map<String, Object> updateParameters, Map<String, Object> whereParameters) throws Exception {
        // construct SQL statement
        StringBuilder sql = new StringBuilder();
        sql.append(" UPDATE Decision SET ");
        int appendCount = 0;
    ...
    public int delete(Map<String, Object> whereParameters) throws Exception {
        // construct SQL statement
        StringBuilder sql = new StringBuilder();
        sql.append(" DELETE FROM Decision ");
